...
module NOC2_NSU256 #(
  parameter [0:0] REG_AFWM_EN = 1'h0,
  parameter [0:0] REG_AFWM_INTR_EN = 1'h0,
  parameter [4:0] REG_AFWM_TIMEOUT_ERR_EN = 5'h00,
  ...
  parameter [11:0] REG_DST_ID_MASK = 12'hFFF,
  ...
  parameter [1:0] REG_PAR_CHK = 2'h0,
  ...
  input [255:0] IF_NOC_AXI_RDATA,
  input [31:0] IF_NOC_AXI_RDATA_PAR,
  ...
  input [1:0] IF_NOC_NPP_IN_NOC_PDEST_ID,
...
// define constants
  `ifndef XIL_XECLIB
 localparam MODULE_NAME = "NOC2_NSU256";
  

      BM_NOC2_NSU256 #(
      .REG_AFWM_EN (REG_AFWM_EN),
      .REG_AFWM_INTR_EN (REG_AFWM_INTR_EN),
      .REG_AFWM_TIMEOUT_ERR_EN (REG_AFWM_TIMEOUT_ERR_EN),
      ...
      .REG_DST_ID_MASK (REG_DST_ID_MASK),
      ...
      .IF_NOC_AXI_ARID_INFO (IF_NOC_AXI_ARID_INFO),
      ...
      .IF_NOC_AXI_ARSRC_INFO (IF_NOC_AXI_ARSRC_INFO),
      ...
      .IF_NOC_AXI_AWID_INFO (IF_NOC_AXI_AWID_INFO),
      ...
      .IF_NOC_AXI_AWSRC_INFO (IF_NOC_AXI_AWSRC_INFO),
      ...
      .IF_NOC_NPP_OUT_NOC_PDEST_ID (IF_NOC_NPP_OUT_NOC_PDEST_ID),
      ...
      .IF_NOC_NPP_IN_NOC_PDEST_ID (IF_NOC_NPP_IN_NOC_PDEST_ID),
