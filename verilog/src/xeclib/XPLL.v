...
// begin behavioral model
  ...
  localparam    SIM_ADJ_CLK0_CASCADE_DELAY = 400; //in picoseconds. This has been provided by HW team.
  integer       clkin_delay =0;
...
`endif
  ...
  initial begin
    #2;
    clkin_delay = (SIM_ADJ_CLK0_CASCADE_BIN==SIM_ADJ_CLK0_CASCADE_TRUE) ? SIM_ADJ_CLK0_CASCADE_DELAY : 0 ;
  end
  
  always @(*) begin
    clkpll = #clkin_delay CLKIN_in;
  end
