...
//  /   /                        OBUFTDS_COMP_ODDR
// /___/   /\      Filename    : OBUFTDS_COMP_ODDR.v
// \   \  /  \
//  \___\/\___\
//
///////////////////////////////////////////////////////////////////////////////
...
// define constants
  localparam MODULE_NAME = "OBUFTDS_COMP_ODDR";
...
`ifdef XIL_DR
  `include "OBUFTDS_COMP_ODDR_dr.v"
`else
...
//  tri0 GTS = glbl.GTS;
  ...
  or O1 (ts, GTS, T);
  bufif0 B1 (OB, I_muxed, ts);
  notif0 N1 (O, I_muxed, ts);
