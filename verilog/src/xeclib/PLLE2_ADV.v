...
//          #(clk0_frac_lt - 50);
 ...
 always  @(negedge clk0in or posedge rst_in_o)
  ...
  always @(clk0in or posedge rst_in_o)
    if (rst_in_o) begin
        clk0_cnt = 8'b0;
        clk0_nf_out = 0;
    end
  ...
  always @(clk1in or posedge rst_in_o)
    if (rst_in_o) begin
        clk1_cnt = 8'b0;
        clk1_out = 0;
    end
  ...
  always @(clk2in or posedge rst_in_o)
    if (rst_in_o) begin
        clk2_cnt = 8'b0;
        clk2_out = 0;
    end
  ...
  always @(clk3in or posedge rst_in_o)
    if (rst_in_o) begin
        clk3_cnt = 8'b0;
        clk3_out = 0;
    end
  ...
  always @(clk4in or posedge rst_in_o)
    if (rst_in_o) begin
        clk4_cnt = 8'b0;
        clk4_out = 0;
    end
  ...
  always @(clk5in or posedge rst_in_o)
    if (rst_in_o) begin
        clk5_cnt = 8'b0;
        clk5_out = 0;
    end
  ...
  always @(clk6in or posedge rst_in_o)
    if (rst_in_o) begin
        clk6_cnt = 8'b0;
        clk6_out = 0;
    end
  ...
  always @(clkfbm1in or posedge rst_in_o)
    if (rst_in_o) begin
        clkfbm1_cnt = 8'b0;
        clkfbm1_nf_out = 0;
    end
  ...
  always @(clkfb_in or posedge rst_in)
    if (rst_in) begin
        clkfbm2_cnt = 8'b0;
        clkfbm2_out = 0;
    end
  ...
  always @(clkpll_r or posedge rst_in)
    if (rst_in) begin
        clkind_cnt = 8'b0;
        clkind_out = 0;
    end
          ...
          if (clkind_cnt < clkind_div1)
                clkind_cnt = clkind_cnt + 1; //CR-1159901,1200237 Changing Non-Blocking to Blocking
          else
                clkind_cnt = 8'b0;
