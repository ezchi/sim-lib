...
// Parameter encodings and registers
  ...
  localparam SIM_DEVICE_VERSAL_AI_EDGE_2 = 6;
  localparam SIM_DEVICE_VERSAL_AI_EDGE_ES1 = 4;
  localparam SIM_DEVICE_VERSAL_AI_EDGE_ES2 = 5;
  localparam SIM_DEVICE_AUTO_CUSTOM_ASOC = 7;
  localparam SIM_DEVICE_VERSAL_HBM = 8;
  localparam SIM_DEVICE_VERSAL_HBM_ES1 = 9;
  localparam SIM_DEVICE_VERSAL_HBM_ES2 = 10;
  localparam SIM_DEVICE_VERSAL_NET = 11;
  localparam SIM_DEVICE_VERSAL_NET_ES1 = 12;
  localparam SIM_DEVICE_VERSAL_NET_ES2 = 13;
  localparam SIM_DEVICE_VERSAL_PREMIUM = 14;
  localparam SIM_DEVICE_VERSAL_PREMIUM_2 = 17;
  ...
  localparam SIM_DEVICE_VERSAL_PRIME_2 = 20;
  localparam SIM_DEVICE_VERSAL_PRIME_ES1 = 19;
  localparam SIM_DEVICE_VERSAL_RF = 21;
  localparam SIM_DEVICE_VERSAL_RF_ES1 = 22;
  localparam SIM_DEVICE_VERSAL_RF_ES2 = 23;
...
`ifdef XIL_XECLIB
  assign SIM_DEVICE_BIN =
      ...
      (SIM_DEVICE_REG == "VERSAL_AI_EDGE_2") ? SIM_DEVICE_VERSAL_AI_EDGE_2 :
      (SIM_DEVICE_REG == "AUTO_CUSTOM_ASOC") ? SIM_DEVICE_AUTO_CUSTOM_ASOC :
      ...
      (SIM_DEVICE_REG == "VERSAL_PREMIUM_2") ? SIM_DEVICE_VERSAL_PREMIUM_2 :
      (SIM_DEVICE_REG == "VERSAL_PRIME") ? SIM_DEVICE_VERSAL_PRIME :
      (SIM_DEVICE_REG == "VERSAL_PRIME_ES1") ? SIM_DEVICE_VERSAL_PRIME_ES1 :
      (SIM_DEVICE_REG == "VERSAL_PRIME_2") ? SIM_DEVICE_VERSAL_PRIME_2 :
      (SIM_DEVICE_REG == "VERSAL_RF") ? SIM_DEVICE_VERSAL_RF :
      (SIM_DEVICE_REG == "VERSAL_RF_ES1") ? SIM_DEVICE_VERSAL_RF_ES1 :
      (SIM_DEVICE_REG == "VERSAL_RF_ES2") ? SIM_DEVICE_VERSAL_RF_ES2 :
...
`ifndef XIL_XECLIB
  always @ (trig_attr) begin
    ...
    if ((attr_test == 1'b1) ||
        ((SIM_DEVICE_REG != "ULTRASCALE_PLUS") &&
         ...
         (SIM_DEVICE_REG != "VERSAL_AI_EDGE_2") &&
         (SIM_DEVICE_REG != "AUTO_CUSTOM_ASOC") &&
         ...
         (SIM_DEVICE_REG != "VERSAL_PREMIUM_2") &&
         (SIM_DEVICE_REG != "VERSAL_PRIME") &&
         (SIM_DEVICE_REG != "VERSAL_PRIME_ES1") &&
         (SIM_DEVICE_REG != "VERSAL_PRIME_2") &&
         (SIM_DEVICE_REG != "VERSAL_RF") &&
         (SIM_DEVICE_REG != "VERSAL_RF_ES1") &&
         (SIM_DEVICE_REG != "VERSAL_RF_ES2"))) begin
      $display("Error: [Unisim %s-101] SIM_DEVICE attribute is set to %s.  Legal values for this attribute are ULTRASCALE_PLUS, VERSAL_AI_CORE, VERSAL_AI_CORE_ES1, VERSAL_AI_EDGE, VERSAL_AI_EDGE_ES1, VERSAL_AI_EDGE_ES2, VERSAL_AI_EDGE_2, AUTO_CUSTOM_ASOC, VERSAL_HBM, VERSAL_HBM_ES1, VERSAL_HBM_ES2, VERSAL_NET, VERSAL_NET_ES1, VERSAL_NET_ES2, VERSAL_PREMIUM, VERSAL_PREMIUM_ES1, VERSAL_PREMIUM_ES2, VERSAL_PREMIUM_2, VERSAL_PRIME, VERSAL_PRIME_ES1, VERSAL_PRIME_2, VERSAL_RF, VERSAL_RF_ES1 or VERSAL_RF_ES2. Instance: %m", MODULE_NAME, SIM_DEVICE_REG);
      attr_err = 1'b1;
    end
  ...
  always @ (trig_attr) begin
    ...
    if (((SIM_DEVICE_BIN != SIM_DEVICE_VERSAL_AI_CORE      ) &&
         ...
         (SIM_DEVICE_BIN != SIM_DEVICE_VERSAL_AI_EDGE_2    ) &&
         (SIM_DEVICE_BIN != SIM_DEVICE_AUTO_CUSTOM_ASOC       ) &&
         (SIM_DEVICE_BIN != SIM_DEVICE_VERSAL_AI_EDGE_ES1  ) &&
         (SIM_DEVICE_BIN != SIM_DEVICE_VERSAL_AI_EDGE_ES2  ) &&
         (SIM_DEVICE_BIN != SIM_DEVICE_VERSAL_RF        ) &&
         (SIM_DEVICE_BIN != SIM_DEVICE_VERSAL_RF_ES1    ) &&
         (SIM_DEVICE_BIN != SIM_DEVICE_VERSAL_RF_ES2    ) &&
         ...
         (SIM_DEVICE_BIN != SIM_DEVICE_VERSAL_PREMIUM_2    ) &&
         ...
         (SIM_DEVICE_BIN != SIM_DEVICE_VERSAL_PRIME_2      ) &&
