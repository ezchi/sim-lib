...
`endif
  parameter DECODER_CODING_STANDARD = "HEVC",
  parameter integer DECODER_COLOR_DEPTH = 12,
  parameter integer DECODER_COLOR_FORMAT = 444,
  parameter integer DECODER_FRAME_PER_SECOND = 60,
  parameter integer DECODER_FREQUENCY = 1050,
  parameter integer DECODER_NO_OF_STREAMS = 1,
  parameter DECODER_RESOLUTION = "4096X2160",
  parameter ENCODER_CODING_STANDARD = "HEVC",
  parameter integer ENCODER_COLOR_DEPTH = 12,
  parameter integer ENCODER_COLOR_FORMAT = 444,
  parameter integer ENCODER_FRAME_PER_SECOND = 60,
  parameter integer ENCODER_FREQUENCY = 1150,
  parameter integer ENCODER_NO_OF_STREAMS = 1,
  parameter ENCODER_RESOLUTION = "4096X2160"
)(
  output NMU_VCU2_0,
  output NMU_VCU2_1,
  output NMU_VCU2_2,
...
// Parameter encodings and registers
  localparam DECODER_CODING_STANDARD_AVC = 1;
  localparam DECODER_CODING_STANDARD_HEVC = 0;
  localparam DECODER_CODING_STANDARD_JPEG = 2;
  localparam DECODER_RESOLUTION_1280X720 = 1;
  localparam DECODER_RESOLUTION_1920X1080 = 2;
  localparam DECODER_RESOLUTION_3840X2160 = 3;
  localparam DECODER_RESOLUTION_4096X2160 = 0;
  localparam ENCODER_CODING_STANDARD_AVC = 1;
  localparam ENCODER_CODING_STANDARD_HEVC = 0;
  localparam ENCODER_RESOLUTION_1280X720 = 1;
  localparam ENCODER_RESOLUTION_1920X1080 = 2;
  localparam ENCODER_RESOLUTION_3840X2160 = 3;
  localparam ENCODER_RESOLUTION_4096X2160 = 0;
...
`ifdef XIL_DR
  `include "VCU2_dr.v"
`else
  reg [32:1] DECODER_CODING_STANDARD_REG = DECODER_CODING_STANDARD;
  reg [31:0] DECODER_COLOR_DEPTH_REG = DECODER_COLOR_DEPTH;
  reg [31:0] DECODER_COLOR_FORMAT_REG = DECODER_COLOR_FORMAT;
  reg [31:0] DECODER_FRAME_PER_SECOND_REG = DECODER_FRAME_PER_SECOND;
  reg [31:0] DECODER_FREQUENCY_REG = DECODER_FREQUENCY;
  reg [31:0] DECODER_NO_OF_STREAMS_REG = DECODER_NO_OF_STREAMS;
  reg [72:1] DECODER_RESOLUTION_REG = DECODER_RESOLUTION;
  reg [32:1] ENCODER_CODING_STANDARD_REG = ENCODER_CODING_STANDARD;
  reg [31:0] ENCODER_COLOR_DEPTH_REG = ENCODER_COLOR_DEPTH;
  reg [31:0] ENCODER_COLOR_FORMAT_REG = ENCODER_COLOR_FORMAT;
  reg [31:0] ENCODER_FRAME_PER_SECOND_REG = ENCODER_FRAME_PER_SECOND;
  reg [31:0] ENCODER_FREQUENCY_REG = ENCODER_FREQUENCY;
  reg [31:0] ENCODER_NO_OF_STREAMS_REG = ENCODER_NO_OF_STREAMS;
  reg [72:1] ENCODER_RESOLUTION_REG = ENCODER_RESOLUTION;
`endif

`ifdef XIL_XECLIB
  wire [1:0] DECODER_CODING_STANDARD_BIN;
  wire [3:0] DECODER_COLOR_DEPTH_BIN;
  wire [8:0] DECODER_COLOR_FORMAT_BIN;
  wire [5:0] DECODER_FRAME_PER_SECOND_BIN;
  wire [10:0] DECODER_FREQUENCY_BIN;
  wire [5:0] DECODER_NO_OF_STREAMS_BIN;
  wire [1:0] DECODER_RESOLUTION_BIN;
  wire ENCODER_CODING_STANDARD_BIN;
  wire [3:0] ENCODER_COLOR_DEPTH_BIN;
  wire [8:0] ENCODER_COLOR_FORMAT_BIN;
  wire [5:0] ENCODER_FRAME_PER_SECOND_BIN;
  wire [10:0] ENCODER_FREQUENCY_BIN;
  wire [5:0] ENCODER_NO_OF_STREAMS_BIN;
  wire [1:0] ENCODER_RESOLUTION_BIN;
`else
  reg [1:0] DECODER_CODING_STANDARD_BIN;
  reg [3:0] DECODER_COLOR_DEPTH_BIN;
  reg [8:0] DECODER_COLOR_FORMAT_BIN;
  reg [5:0] DECODER_FRAME_PER_SECOND_BIN;
  reg [10:0] DECODER_FREQUENCY_BIN;
  reg [5:0] DECODER_NO_OF_STREAMS_BIN;
  reg [1:0] DECODER_RESOLUTION_BIN;
  reg ENCODER_CODING_STANDARD_BIN;
  reg [3:0] ENCODER_COLOR_DEPTH_BIN;
  reg [8:0] ENCODER_COLOR_FORMAT_BIN;
  reg [5:0] ENCODER_FRAME_PER_SECOND_BIN;
  reg [10:0] ENCODER_FREQUENCY_BIN;
  reg [5:0] ENCODER_NO_OF_STREAMS_BIN;
  reg [1:0] ENCODER_RESOLUTION_BIN;
`endif
...
`ifdef XIL_XECLIB
  assign DECODER_CODING_STANDARD_BIN =
      (DECODER_CODING_STANDARD_REG == "HEVC") ? DECODER_CODING_STANDARD_HEVC :
      (DECODER_CODING_STANDARD_REG == "AVC") ? DECODER_CODING_STANDARD_AVC :
      (DECODER_CODING_STANDARD_REG == "JPEG") ? DECODER_CODING_STANDARD_JPEG :
       DECODER_CODING_STANDARD_HEVC;
  
  assign DECODER_COLOR_DEPTH_BIN = DECODER_COLOR_DEPTH_REG[3:0];
  
  assign DECODER_COLOR_FORMAT_BIN = DECODER_COLOR_FORMAT_REG[8:0];
  
  assign DECODER_FRAME_PER_SECOND_BIN = DECODER_FRAME_PER_SECOND_REG[5:0];
  
  assign DECODER_FREQUENCY_BIN = DECODER_FREQUENCY_REG[10:0];
  
  assign DECODER_NO_OF_STREAMS_BIN = DECODER_NO_OF_STREAMS_REG[5:0];
  
  assign DECODER_RESOLUTION_BIN =
      (DECODER_RESOLUTION_REG == "4096X2160") ? DECODER_RESOLUTION_4096X2160 :
      (DECODER_RESOLUTION_REG == "1280X720") ? DECODER_RESOLUTION_1280X720 :
      (DECODER_RESOLUTION_REG == "1920X1080") ? DECODER_RESOLUTION_1920X1080 :
      (DECODER_RESOLUTION_REG == "3840X2160") ? DECODER_RESOLUTION_3840X2160 :
       DECODER_RESOLUTION_4096X2160;
  
  assign ENCODER_CODING_STANDARD_BIN =
      (ENCODER_CODING_STANDARD_REG == "HEVC") ? ENCODER_CODING_STANDARD_HEVC :
      (ENCODER_CODING_STANDARD_REG == "AVC") ? ENCODER_CODING_STANDARD_AVC :
       ENCODER_CODING_STANDARD_HEVC;
  
  assign ENCODER_COLOR_DEPTH_BIN = ENCODER_COLOR_DEPTH_REG[3:0];
  
  assign ENCODER_COLOR_FORMAT_BIN = ENCODER_COLOR_FORMAT_REG[8:0];
  
  assign ENCODER_FRAME_PER_SECOND_BIN = ENCODER_FRAME_PER_SECOND_REG[5:0];
  
  assign ENCODER_FREQUENCY_BIN = ENCODER_FREQUENCY_REG[10:0];
  
  assign ENCODER_NO_OF_STREAMS_BIN = ENCODER_NO_OF_STREAMS_REG[5:0];
  
  assign ENCODER_RESOLUTION_BIN =
      (ENCODER_RESOLUTION_REG == "4096X2160") ? ENCODER_RESOLUTION_4096X2160 :
      (ENCODER_RESOLUTION_REG == "1280X720") ? ENCODER_RESOLUTION_1280X720 :
      (ENCODER_RESOLUTION_REG == "1920X1080") ? ENCODER_RESOLUTION_1920X1080 :
      (ENCODER_RESOLUTION_REG == "3840X2160") ? ENCODER_RESOLUTION_3840X2160 :
       ENCODER_RESOLUTION_4096X2160;
  
`else
  always @ (trig_attr) begin
  #1;
  DECODER_CODING_STANDARD_BIN =
      (DECODER_CODING_STANDARD_REG == "HEVC") ? DECODER_CODING_STANDARD_HEVC :
      (DECODER_CODING_STANDARD_REG == "AVC") ? DECODER_CODING_STANDARD_AVC :
      (DECODER_CODING_STANDARD_REG == "JPEG") ? DECODER_CODING_STANDARD_JPEG :
       DECODER_CODING_STANDARD_HEVC;
  
  DECODER_COLOR_DEPTH_BIN = DECODER_COLOR_DEPTH_REG[3:0];
  
  DECODER_COLOR_FORMAT_BIN = DECODER_COLOR_FORMAT_REG[8:0];
  
  DECODER_FRAME_PER_SECOND_BIN = DECODER_FRAME_PER_SECOND_REG[5:0];
  
  DECODER_FREQUENCY_BIN = DECODER_FREQUENCY_REG[10:0];
  
  DECODER_NO_OF_STREAMS_BIN = DECODER_NO_OF_STREAMS_REG[5:0];
  
  DECODER_RESOLUTION_BIN =
      (DECODER_RESOLUTION_REG == "4096X2160") ? DECODER_RESOLUTION_4096X2160 :
      (DECODER_RESOLUTION_REG == "1280X720") ? DECODER_RESOLUTION_1280X720 :
      (DECODER_RESOLUTION_REG == "1920X1080") ? DECODER_RESOLUTION_1920X1080 :
      (DECODER_RESOLUTION_REG == "3840X2160") ? DECODER_RESOLUTION_3840X2160 :
  ...
  ENCODER_CODING_STANDARD_BIN =
      (ENCODER_CODING_STANDARD_REG == "HEVC") ? ENCODER_CODING_STANDARD_HEVC :
      (ENCODER_CODING_STANDARD_REG == "AVC") ? ENCODER_CODING_STANDARD_AVC :
       ENCODER_CODING_STANDARD_HEVC;
  
  ENCODER_COLOR_DEPTH_BIN = ENCODER_COLOR_DEPTH_REG[3:0];
  
  ENCODER_COLOR_FORMAT_BIN = ENCODER_COLOR_FORMAT_REG[8:0];
  
  ENCODER_FRAME_PER_SECOND_BIN = ENCODER_FRAME_PER_SECOND_REG[5:0];
  
  ENCODER_FREQUENCY_BIN = ENCODER_FREQUENCY_REG[10:0];
  
  ENCODER_NO_OF_STREAMS_BIN = ENCODER_NO_OF_STREAMS_REG[5:0];
  
  ENCODER_RESOLUTION_BIN =
      (ENCODER_RESOLUTION_REG == "4096X2160") ? ENCODER_RESOLUTION_4096X2160 :
      (ENCODER_RESOLUTION_REG == "1280X720") ? ENCODER_RESOLUTION_1280X720 :
      (ENCODER_RESOLUTION_REG == "1920X1080") ? ENCODER_RESOLUTION_1920X1080 :
      (ENCODER_RESOLUTION_REG == "3840X2160") ? ENCODER_RESOLUTION_3840X2160 :
...
`ifndef XIL_XECLIB
  always @ (trig_attr) begin
    #1;
    if ((attr_test == 1'b1) ||
        ((DECODER_CODING_STANDARD_REG != "HEVC") &&
         (DECODER_CODING_STANDARD_REG != "AVC") &&
         (DECODER_CODING_STANDARD_REG != "JPEG"))) begin
      $display("Error: [Unisim %s-101] DECODER_CODING_STANDARD attribute is set to %s.  Legal values for this attribute are HEVC, AVC or JPEG. Instance: %m", MODULE_NAME, DECODER_CODING_STANDARD_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((DECODER_COLOR_DEPTH_REG != 12) &&
         (DECODER_COLOR_DEPTH_REG != 8) &&
         (DECODER_COLOR_DEPTH_REG != 10))) begin
      $display("Error: [Unisim %s-102] DECODER_COLOR_DEPTH attribute is set to %d.  Legal values for this attribute are 12, 8 or 10. Instance: %m", MODULE_NAME, DECODER_COLOR_DEPTH_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((DECODER_COLOR_FORMAT_REG != 444) &&
         (DECODER_COLOR_FORMAT_REG != 400) &&
         (DECODER_COLOR_FORMAT_REG != 420) &&
         (DECODER_COLOR_FORMAT_REG != 422))) begin
      $display("Error: [Unisim %s-103] DECODER_COLOR_FORMAT attribute is set to %d.  Legal values for this attribute are 444, 400, 420 or 422. Instance: %m", MODULE_NAME, DECODER_COLOR_FORMAT_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((DECODER_FRAME_PER_SECOND_REG != 60) &&
         (DECODER_FRAME_PER_SECOND_REG != 15) &&
         (DECODER_FRAME_PER_SECOND_REG != 30))) begin
      $display("Error: [Unisim %s-104] DECODER_FRAME_PER_SECOND attribute is set to %d.  Legal values for this attribute are 60, 15 or 30. Instance: %m", MODULE_NAME, DECODER_FRAME_PER_SECOND_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((DECODER_FREQUENCY_REG != 1050) &&
         (DECODER_FREQUENCY_REG != 660) &&
         (DECODER_FREQUENCY_REG != 880))) begin
      $display("Error: [Unisim %s-105] DECODER_FREQUENCY attribute is set to %d.  Legal values for this attribute are 1050, 660 or 880. Instance: %m", MODULE_NAME, DECODER_FREQUENCY_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((DECODER_NO_OF_STREAMS_REG < 1) || (DECODER_NO_OF_STREAMS_REG > 36))) begin
      $display("Error: [Unisim %s-106] DECODER_NO_OF_STREAMS attribute is set to %d.  Legal values for this attribute are 1 to 36. Instance: %m", MODULE_NAME, DECODER_NO_OF_STREAMS_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((DECODER_RESOLUTION_REG != "4096X2160") &&
         (DECODER_RESOLUTION_REG != "1280X720") &&
         (DECODER_RESOLUTION_REG != "1920X1080") &&
         (DECODER_RESOLUTION_REG != "3840X2160"))) begin
      $display("Error: [Unisim %s-107] DECODER_RESOLUTION attribute is set to %s.  Legal values for this attribute are 4096X2160, 1280X720, 1920X1080 or 3840X2160. Instance: %m", MODULE_NAME, DECODER_RESOLUTION_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((ENCODER_CODING_STANDARD_REG != "HEVC") &&
         (ENCODER_CODING_STANDARD_REG != "AVC"))) begin
      $display("Error: [Unisim %s-108] ENCODER_CODING_STANDARD attribute is set to %s.  Legal values for this attribute are HEVC or AVC. Instance: %m", MODULE_NAME, ENCODER_CODING_STANDARD_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((ENCODER_COLOR_DEPTH_REG != 12) &&
         (ENCODER_COLOR_DEPTH_REG != 8) &&
         (ENCODER_COLOR_DEPTH_REG != 10))) begin
      $display("Error: [Unisim %s-109] ENCODER_COLOR_DEPTH attribute is set to %d.  Legal values for this attribute are 12, 8 or 10. Instance: %m", MODULE_NAME, ENCODER_COLOR_DEPTH_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((ENCODER_COLOR_FORMAT_REG != 444) &&
         (ENCODER_COLOR_FORMAT_REG != 400) &&
         (ENCODER_COLOR_FORMAT_REG != 420) &&
         (ENCODER_COLOR_FORMAT_REG != 422))) begin
      $display("Error: [Unisim %s-110] ENCODER_COLOR_FORMAT attribute is set to %d.  Legal values for this attribute are 444, 400, 420 or 422. Instance: %m", MODULE_NAME, ENCODER_COLOR_FORMAT_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((ENCODER_FRAME_PER_SECOND_REG != 60) &&
         (ENCODER_FRAME_PER_SECOND_REG != 15) &&
         (ENCODER_FRAME_PER_SECOND_REG != 30))) begin
      $display("Error: [Unisim %s-111] ENCODER_FRAME_PER_SECOND attribute is set to %d.  Legal values for this attribute are 60, 15 or 30. Instance: %m", MODULE_NAME, ENCODER_FRAME_PER_SECOND_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((ENCODER_FREQUENCY_REG != 1150) &&
         (ENCODER_FREQUENCY_REG != 660) &&
         (ENCODER_FREQUENCY_REG != 950))) begin
      $display("Error: [Unisim %s-112] ENCODER_FREQUENCY attribute is set to %d.  Legal values for this attribute are 1150, 660 or 950. Instance: %m", MODULE_NAME, ENCODER_FREQUENCY_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((ENCODER_NO_OF_STREAMS_REG < 1) || (ENCODER_NO_OF_STREAMS_REG > 36))) begin
      $display("Error: [Unisim %s-113] ENCODER_NO_OF_STREAMS attribute is set to %d.  Legal values for this attribute are 1 to 36. Instance: %m", MODULE_NAME, ENCODER_NO_OF_STREAMS_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((ENCODER_RESOLUTION_REG != "4096X2160") &&
         (ENCODER_RESOLUTION_REG != "1280X720") &&
         (ENCODER_RESOLUTION_REG != "1920X1080") &&
         (ENCODER_RESOLUTION_REG != "3840X2160"))) begin
      $display("Error: [Unisim %s-114] ENCODER_RESOLUTION attribute is set to %s.  Legal values for this attribute are 4096X2160, 1280X720, 1920X1080 or 3840X2160. Instance: %m", MODULE_NAME, ENCODER_RESOLUTION_REG);
      attr_err = 1'b1;
    end
...
`ifdef XIL_TIMING
  ...
  specify
    $period (negedge VCU2AXISLAVEDEBUGCLK, 0:0:0, notifier);
    $period (negedge VCU2DECDEBUGCLK, 0:0:0, notifier);
    $period (negedge VCU2ENCDEBUGCLK, 0:0:0, notifier);
    $period (posedge VCU2AXISLAVEDEBUGCLK, 0:0:0, notifier);
    $period (posedge VCU2DECDEBUGCLK, 0:0:0, notifier);
    $period (posedge VCU2ENCDEBUGCLK, 0:0:0, notifier);
    $width (negedge VCU2AXISLAVEDEBUGCLK, 0:0:0, 0, notifier);
    $width (negedge VCU2DECDEBUGCLK, 0:0:0, 0, notifier);
    $width (negedge VCU2ENCDEBUGCLK, 0:0:0, 0, notifier);
    $width (posedge VCU2AXISLAVEDEBUGCLK, 0:0:0, 0, notifier);
    $width (posedge VCU2DECDEBUGCLK, 0:0:0, 0, notifier);
    $width (posedge VCU2ENCDEBUGCLK, 0:0:0, 0, notifier);
