...
// Parameter encodings and registers
  ...
  localparam SIM_DEVICE_VERSAL_PREMIUM_2 = 19;
  ...
  localparam SIM_DEVICE_VERSAL_PRIME_2 = 22;
  localparam SIM_DEVICE_VERSAL_PRIME_ES1 = 21;
  localparam SIM_DEVICE_VERSAL_RF = 23;
  localparam SIM_DEVICE_VERSAL_RF_ES1 = 24;
  localparam SIM_DEVICE_VERSAL_RF_ES2 = 25;
...
`endif
  ...
  always @(*) begin
    #0; //Delay to avoid race as variables state0 and state1 are updated in the always block just above this block.
    case ({state1,state0})
      2'b00   : O_out = 1'b0;
      2'b01   : O_out = I1_in;
      2'b10   : O_out = I0_in;
