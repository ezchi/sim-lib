...
`endif
  ...
  parameter SIM_OUTPUT_IMPEDANCE_M = "RDRV_NONE_NONE",
  parameter SIM_OUTPUT_IMPEDANCE_S = "RDRV_NONE_NONE",
...
`else
  ...
  reg [18*8:1] ISTANDARD_M_REG = ISTANDARD_M;
  //reg [48:1] ISTANDARD_S_REG = ISTANDARD_S;
  reg [18*8:1] ISTANDARD_S_REG = ISTANDARD_S;
  ...
  reg [112:1] SIM_OUTPUT_IMPEDANCE_M_REG = SIM_OUTPUT_IMPEDANCE_M;
  reg [112:1] SIM_OUTPUT_IMPEDANCE_S_REG = SIM_OUTPUT_IMPEDANCE_S;
...
`ifndef XIL_XECLIB
  always @ (trig_attr) begin
    ...
    if ((attr_test == 1'b1) ||
        ((SIM_OUTPUT_IMPEDANCE_M_REG != "RDRV_NONE_NONE") &&
         (SIM_OUTPUT_IMPEDANCE_M_REG != "RDRV_30_30") &&
         (SIM_OUTPUT_IMPEDANCE_M_REG != "RDRV_34_34") &&
         (SIM_OUTPUT_IMPEDANCE_M_REG != "RDRV_40_40") &&
         (SIM_OUTPUT_IMPEDANCE_M_REG != "RDRV_48_48") &&
         (SIM_OUTPUT_IMPEDANCE_M_REG != "RDRV_60_60"))) begin
      $display("Error: [Unisim %s-264] SIM_OUTPUT_IMPEDANCE_M attribute is set to %s.  Legal values for this attribute are RDRV_NONE_NONE, RDRV_30_30, RDRV_34_34, RDRV_40_40, RDRV_48_48 or RDRV_60_60. Instance: %m", MODULE_NAME, SIM_OUTPUT_IMPEDANCE_M_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((SIM_OUTPUT_IMPEDANCE_S_REG != "RDRV_NONE_NONE") &&
         (SIM_OUTPUT_IMPEDANCE_S_REG != "RDRV_30_30") &&
         (SIM_OUTPUT_IMPEDANCE_S_REG != "RDRV_34_34") &&
         (SIM_OUTPUT_IMPEDANCE_S_REG != "RDRV_40_40") &&
         (SIM_OUTPUT_IMPEDANCE_S_REG != "RDRV_48_48") &&
         (SIM_OUTPUT_IMPEDANCE_S_REG != "RDRV_60_60"))) begin
      $display("Error: [Unisim %s-265] SIM_OUTPUT_IMPEDANCE_S attribute is set to %s.  Legal values for this attribute are RDRV_NONE_NONE, RDRV_30_30, RDRV_34_34, RDRV_40_40, RDRV_48_48 or RDRV_60_60. Instance: %m", MODULE_NAME, SIM_OUTPUT_IMPEDANCE_S_REG);
      attr_err = 1'b1;
    end
    
    if ((attr_test == 1'b1) ||
        ((SIM_VERSION_REG < 1) || (SIM_VERSION_REG > 3))) begin
      $display("Error: [Unisim %s-266] SIM_VERSION attribute is set to %d.  Legal values for this attribute are 1 to 3. Instance: %m", MODULE_NAME, SIM_VERSION_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-267] SLEW_M attribute is set to %s.  Legal values for this attribute are FAST, MEDIUM or SLOW. Instance: %m", MODULE_NAME, SLEW_M_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-268] SLEW_S attribute is set to %s.  Legal values for this attribute are FAST, MEDIUM or SLOW. Instance: %m", MODULE_NAME, SLEW_S_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-269] SLV_WRLVL_MODE attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, SLV_WRLVL_MODE_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-276] TX0_ODLY_CASC_EN attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, TX0_ODLY_CASC_EN_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-278] TX0_OUTPUT_PHASE_90 attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, TX0_OUTPUT_PHASE_90_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-283] TX1_ODLY_CASC_EN attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, TX1_ODLY_CASC_EN_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-285] TX1_OUTPUT_PHASE_90 attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, TX1_OUTPUT_PHASE_90_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-286] TX2RX_PREDRV_LOOPBACK_M attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, TX2RX_PREDRV_LOOPBACK_M_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-287] TX2RX_PREDRV_LOOPBACK_S attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, TX2RX_PREDRV_LOOPBACK_S_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-288] TX2RX_RETIMER_LOOPBACK_M attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, TX2RX_RETIMER_LOOPBACK_M_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-289] TX2RX_RETIMER_LOOPBACK_S attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, TX2RX_RETIMER_LOOPBACK_S_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-294] TX_DATA_WIDTH attribute is set to %d.  Legal values for this attribute are 16, 2, 4 or 8. Instance: %m", MODULE_NAME, TX_DATA_WIDTH_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-295] TX_DRV_HP_EN_M attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, TX_DRV_HP_EN_M_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-296] TX_DRV_HP_EN_S attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, TX_DRV_HP_EN_S_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-297] TX_INIT_0 attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, TX_INIT_0_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-298] TX_INIT_1 attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, TX_INIT_1_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-299] TX_INIT_T attribute is set to %s.  Legal values for this attribute are FALSE or TRUE. Instance: %m", MODULE_NAME, TX_INIT_T_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-300] USE_IBUFDISABLE_M attribute is set to %s.  Legal values for this attribute are FALSE_IBUFDIS, T_CONTROL_MODE0, T_CONTROL_MODE1, T_CONTROL_MODE2, TRUE_IBUFDIS_MODE0, TRUE_IBUFDIS_MODE1 or TRUE_IBUFDIS_MODE2. Instance: %m", MODULE_NAME, USE_IBUFDISABLE_M_REG);
      attr_err = 1'b1;
    end
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-301] USE_IBUFDISABLE_S attribute is set to %s.  Legal values for this attribute are FALSE_IBUFDIS, T_CONTROL_MODE0, T_CONTROL_MODE1, T_CONTROL_MODE2, TRUE_IBUFDIS_MODE0, TRUE_IBUFDIS_MODE1 or TRUE_IBUFDIS_MODE2. Instance: %m", MODULE_NAME, USE_IBUFDISABLE_S_REG);
      attr_err = 1'b1;
    end
...
assign XCVR_X2_ID_in = 2'b11; // tie off
  ...
  SIP_X5PHIO_XCVR_X2 SIP_X5PHIO_XCVR_X2_INST (
    ...
    .SIM_OUTPUT_IMPEDANCE_M (SIM_OUTPUT_IMPEDANCE_M_REG),
    .SIM_OUTPUT_IMPEDANCE_S (SIM_OUTPUT_IMPEDANCE_S_REG),
...
`ifdef XIL_TIMING
  ...
  specify
    ...
    (PHY2XCV_IBUF_DIS_OR_HS_RX_DIS[1] => XCV2PHYPLL_RX_OUT_M) = (0:0:0, 0:0:0);
