...
// Parameter encodings and registers
  ...
  localparam SIM_DEVICE_VERSAL_AI_EDGE = 2;
  localparam SIM_DEVICE_VERSAL_AI_EDGE_2 = 5;
  localparam SIM_DEVICE_VERSAL_AI_EDGE_ES1 = 3;
  localparam SIM_DEVICE_VERSAL_AI_EDGE_ES2 = 4;
  localparam SIM_DEVICE_AUTO_CUSTOM_ASOC = 6;
  localparam SIM_DEVICE_VERSAL_HBM = 7;
  localparam SIM_DEVICE_VERSAL_HBM_ES1 = 8;
  localparam SIM_DEVICE_VERSAL_HBM_ES2 = 9;
  localparam SIM_DEVICE_VERSAL_NET = 10;
  localparam SIM_DEVICE_VERSAL_NET_ES1 = 11;
  localparam SIM_DEVICE_VERSAL_NET_ES2 = 12;
  localparam SIM_DEVICE_VERSAL_PREMIUM = 13;
  localparam SIM_DEVICE_VERSAL_PREMIUM_2 = 16;
  ...
  localparam SIM_DEVICE_VERSAL_PRIME_2 = 19;
  localparam SIM_DEVICE_VERSAL_PRIME_ES1 = 18;
  localparam SIM_DEVICE_VERSAL_RF = 20;
  localparam SIM_DEVICE_VERSAL_RF_ES1 = 21;
  localparam SIM_DEVICE_VERSAL_RF_ES2 = 22;
...
`else
  ...
  always @(posedge O2_out or negedge CLRB_LEAF_in) begin
    if(~CLRB_LEAF_in)
      O3_out=0;
    else
      O3_out = ~O3_out;    
  ...
  always @(posedge O3_out or negedge CLRB_LEAF_in) begin
    if(~CLRB_LEAF_in)
      O4_out=0;
    else
      O4_out =  ~O4_out;    
