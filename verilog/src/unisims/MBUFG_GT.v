...
// Parameter encodings and registers
  ...
  localparam SIM_DEVICE_AUTO_CUSTOM_ASOC = 1;
  ...
  localparam SIM_DEVICE_VERSAL_HBM = 6;
  localparam SIM_DEVICE_VERSAL_HBM_ES1 = 7;
  localparam SIM_DEVICE_VERSAL_HBM_ES2 = 8;
  localparam SIM_DEVICE_VERSAL_NET = 9;
  localparam SIM_DEVICE_VERSAL_NET_ES1 = 10;
  localparam SIM_DEVICE_VERSAL_NET_ES2 = 11;
  localparam SIM_DEVICE_VERSAL_PREMIUM = 12;
  localparam SIM_DEVICE_VERSAL_PREMIUM_2 = 15;
  ...
  localparam SIM_DEVICE_VERSAL_PRIME_2 = 18;
  localparam SIM_DEVICE_VERSAL_PRIME_ES1 = 17;
  localparam SIM_DEVICE_VERSAL_RF = 19;
  localparam SIM_DEVICE_VERSAL_RF_ES1 = 20;
  localparam SIM_DEVICE_VERSAL_RF_ES2 = 21;
...
`ifndef XIL_XECLIB
  always @ (trig_attr) begin
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-102] SIM_DEVICE attribute is set to %s.  Legal values for this attribute are VERSAL_AI_CORE, AUTO_CUSTOM_ASOC, VERSAL_AI_CORE_ES1, VERSAL_AI_EDGE, VERSAL_AI_EDGE_ES1, VERSAL_AI_EDGE_ES2, VERSAL_HBM, VERSAL_HBM_ES1, VERSAL_HBM_ES2, VERSAL_NET, VERSAL_NET_ES1, VERSAL_NET_ES2, VERSAL_PREMIUM, VERSAL_PREMIUM_ES1, VERSAL_PREMIUM_ES2, VERSAL_PREMIUM_2, VERSAL_PRIME, VERSAL_PRIME_ES1, VERSAL_PRIME_2, VERSAL_RF, VERSAL_RF_ES1 or VERSAL_RF_ES2. Instance: %m", MODULE_NAME, SIM_DEVICE_REG);
      attr_err = 1'b1;
    end
