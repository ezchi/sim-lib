...
// Parameter encodings and registers
  ...
  localparam SIM_DEVICE_VERSAL_RF = 8;
  localparam SIM_DEVICE_VERSAL_RF_ES1 = 9;
  localparam SIM_DEVICE_VERSAL_RF_ES2 = 10;
...
`ifndef XIL_XECLIB
  always @ (trig_attr) begin
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display("Error: [Unisim %s-104] USE_IBUFDISABLE attribute is set to %s.  Legal values for this attribute are TRUE, FALSE or T_CONTROL. Instance: %m", MODULE_NAME, USE_IBUFDISABLE_REG);
      attr_err = 1'b1;
    end
