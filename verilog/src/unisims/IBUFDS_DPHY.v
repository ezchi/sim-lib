  ...
  always @ (trig_attr) begin
    ...
    if ((attr_test == 1'b1) ||
        ((SIM_DEVICE != "ULTRASCALE_PLUS") &&
         ...
         (SIM_DEVICE != "VERSAL_AI_EDGE_2") &&
         (SIM_DEVICE != "VERSAL_AI_EDGE_ES1") &&
         (SIM_DEVICE != "VERSAL_AI_EDGE_ES2") &&
         (SIM_DEVICE != "VERSAL_RF") &&
         (SIM_DEVICE != "VERSAL_RF_ES1") &&
         (SIM_DEVICE != "VERSAL_RF_ES2") &&
         ...
         (SIM_DEVICE != "VERSAL_PRIME_2") &&
         (SIM_DEVICE != "VERSAL_PRIME_ES1"))) begin
      $display("Error: [Unisim %s-102] SIM_DEVICE attribute is set to %s.  Legal values for this attribute are ULTRASCALE_PLUS, ULTRASCALE_PLUS_ES1, ULTRASCALE_PLUS_ES2, VERSAL_AI_CORE, VERSAL_AI_CORE_ES1, VERSAL_AI_EDGE, VERSAL_AI_EDGE_ES1, VERSAL_AI_EDGE_ES2, VERSAL_AI_EDGE_2, VERSAL_RF, VERSAL_RF_ES1, VERSAL_RF_ES2, VERSAL_HBM, VERSAL_HBM_ES1, VERSAL_HBM_ES2, VERSAL_PREMIUM, VERSAL_PREMIUM_ES1, VERSAL_PREMIUM_ES2, VERSAL_PRIME, VERSAL_PRIME_ES1 or VERSAL_PRIME_2. Instance: %m", MODULE_NAME, SIM_DEVICE);
      attr_err = 1'b1;
    end
