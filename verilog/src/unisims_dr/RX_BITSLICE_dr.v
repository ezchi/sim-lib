...
reg [`RX_BITSLICE__CASCADE_SZ:1] CASCADE_REG = CASCADE;
reg [`RX_BITSLICE__DATA_TYPE_SZ:1] DATA_TYPE_REG = DATA_TYPE;
reg [`RX_BITSLICE__DATA_WIDTH_SZ-1:0] DATA_WIDTH_REG = DATA_WIDTH;
reg [`RX_BITSLICE__DELAY_FORMAT_SZ:1] DELAY_FORMAT_REG = DELAY_FORMAT;
reg [`RX_BITSLICE__DELAY_TYPE_SZ:1] DELAY_TYPE_REG = DELAY_TYPE;
reg [`RX_BITSLICE__DELAY_VALUE_SZ-1:0] DELAY_VALUE_REG = DELAY_VALUE;
reg [`RX_BITSLICE__DELAY_VALUE_EXT_SZ-1:0] DELAY_VALUE_EXT_REG = DELAY_VALUE_EXT;
reg [`RX_BITSLICE__FIFO_SYNC_MODE_SZ:1] FIFO_SYNC_MODE_REG = FIFO_SYNC_MODE;
...
reg [`RX_BITSLICE__SIM_DEVICE_SZ:1] SIM_DEVICE_REG = SIM_DEVICE;
real SIM_VERSION_REG = SIM_VERSION;
reg [`RX_BITSLICE__UPDATE_MODE_SZ:1] UPDATE_MODE_REG = UPDATE_MODE;
reg [`RX_BITSLICE__UPDATE_MODE_EXT_SZ:1] UPDATE_MODE_EXT_REG = UPDATE_MODE_EXT;
...
initial begin
  ...
  ATTR[`RX_BITSLICE__SIM_DEVICE] = SIM_DEVICE;
...
always @(trig_attr) begin
  ...
  SIM_DEVICE_REG = ATTR[`RX_BITSLICE__SIM_DEVICE];
