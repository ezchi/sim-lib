...
reg [`MMCME3_ADV__BANDWIDTH_SZ:1] BANDWIDTH_REG = BANDWIDTH;
real CLKFBOUT_MULT_F_REG = CLKFBOUT_MULT_F;
real CLKFBOUT_PHASE_REG = CLKFBOUT_PHASE;
reg [`MMCME3_ADV__CLKFBOUT_USE_FINE_PS_SZ:1] CLKFBOUT_USE_FINE_PS_REG = CLKFBOUT_USE_FINE_PS;
...
reg [`MMCME3_ADV__CLKOUT0_USE_FINE_PS_SZ:1] CLKOUT0_USE_FINE_PS_REG = CLKOUT0_USE_FINE_PS;
reg [`MMCME3_ADV__CLKOUT1_DIVIDE_SZ-1:0] CLKOUT1_DIVIDE_REG = CLKOUT1_DIVIDE;
real CLKOUT1_DUTY_CYCLE_REG = CLKOUT1_DUTY_CYCLE;
real CLKOUT1_PHASE_REG = CLKOUT1_PHASE;
reg [`MMCME3_ADV__CLKOUT1_USE_FINE_PS_SZ:1] CLKOUT1_USE_FINE_PS_REG = CLKOUT1_USE_FINE_PS;
reg [`MMCME3_ADV__CLKOUT2_DIVIDE_SZ-1:0] CLKOUT2_DIVIDE_REG = CLKOUT2_DIVIDE;
real CLKOUT2_DUTY_CYCLE_REG = CLKOUT2_DUTY_CYCLE;
real CLKOUT2_PHASE_REG = CLKOUT2_PHASE;
reg [`MMCME3_ADV__CLKOUT2_USE_FINE_PS_SZ:1] CLKOUT2_USE_FINE_PS_REG = CLKOUT2_USE_FINE_PS;
reg [`MMCME3_ADV__CLKOUT3_DIVIDE_SZ-1:0] CLKOUT3_DIVIDE_REG = CLKOUT3_DIVIDE;
real CLKOUT3_DUTY_CYCLE_REG = CLKOUT3_DUTY_CYCLE;
real CLKOUT3_PHASE_REG = CLKOUT3_PHASE;
reg [`MMCME3_ADV__CLKOUT3_USE_FINE_PS_SZ:1] CLKOUT3_USE_FINE_PS_REG = CLKOUT3_USE_FINE_PS;
reg [`MMCME3_ADV__CLKOUT4_CASCADE_SZ:1] CLKOUT4_CASCADE_REG = CLKOUT4_CASCADE;
reg [`MMCME3_ADV__CLKOUT4_DIVIDE_SZ-1:0] CLKOUT4_DIVIDE_REG = CLKOUT4_DIVIDE;
real CLKOUT4_DUTY_CYCLE_REG = CLKOUT4_DUTY_CYCLE;
real CLKOUT4_PHASE_REG = CLKOUT4_PHASE;
reg [`MMCME3_ADV__CLKOUT4_USE_FINE_PS_SZ:1] CLKOUT4_USE_FINE_PS_REG = CLKOUT4_USE_FINE_PS;
reg [`MMCME3_ADV__CLKOUT5_DIVIDE_SZ-1:0] CLKOUT5_DIVIDE_REG = CLKOUT5_DIVIDE;
real CLKOUT5_DUTY_CYCLE_REG = CLKOUT5_DUTY_CYCLE;
real CLKOUT5_PHASE_REG = CLKOUT5_PHASE;
reg [`MMCME3_ADV__CLKOUT5_USE_FINE_PS_SZ:1] CLKOUT5_USE_FINE_PS_REG = CLKOUT5_USE_FINE_PS;
reg [`MMCME3_ADV__CLKOUT6_DIVIDE_SZ-1:0] CLKOUT6_DIVIDE_REG = CLKOUT6_DIVIDE;
real CLKOUT6_DUTY_CYCLE_REG = CLKOUT6_DUTY_CYCLE;
real CLKOUT6_PHASE_REG = CLKOUT6_PHASE;
reg [`MMCME3_ADV__CLKOUT6_USE_FINE_PS_SZ:1] CLKOUT6_USE_FINE_PS_REG = CLKOUT6_USE_FINE_PS;
real CLKPFD_FREQ_MAX_REG = CLKPFD_FREQ_MAX;
real CLKPFD_FREQ_MIN_REG = CLKPFD_FREQ_MIN;
reg [`MMCME3_ADV__COMPENSATION_SZ:1] COMPENSATION_REG = COMPENSATION;
reg [`MMCME3_ADV__DIVCLK_DIVIDE_SZ-1:0] DIVCLK_DIVIDE_REG = DIVCLK_DIVIDE;
...
reg [`MMCME3_ADV__SS_EN_SZ:1] SS_EN_REG = SS_EN;
reg [`MMCME3_ADV__SS_MODE_SZ:1] SS_MODE_REG = SS_MODE;
reg [`MMCME3_ADV__SS_MOD_PERIOD_SZ-1:0] SS_MOD_PERIOD_REG = SS_MOD_PERIOD;
reg [`MMCME3_ADV__STARTUP_WAIT_SZ:1] STARTUP_WAIT_REG = STARTUP_WAIT;
