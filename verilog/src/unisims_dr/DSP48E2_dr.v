...
reg [`DSP48E2__ACASCREG_SZ-1:0] ACASCREG_REG = ACASCREG;
reg [`DSP48E2__ADREG_SZ-1:0] ADREG_REG = ADREG;
reg [`DSP48E2__ALUMODEREG_SZ-1:0] ALUMODEREG_REG = ALUMODEREG;
reg [`DSP48E2__AMULTSEL_SZ:1] AMULTSEL_REG = AMULTSEL;
reg [`DSP48E2__AREG_SZ-1:0] AREG_REG = AREG;
reg [`DSP48E2__AUTORESET_PATDET_SZ:1] AUTORESET_PATDET_REG = AUTORESET_PATDET;
reg [`DSP48E2__AUTORESET_PRIORITY_SZ:1] AUTORESET_PRIORITY_REG = AUTORESET_PRIORITY;
reg [`DSP48E2__A_INPUT_SZ:1] A_INPUT_REG = A_INPUT;
reg [`DSP48E2__BCASCREG_SZ-1:0] BCASCREG_REG = BCASCREG;
reg [`DSP48E2__BMULTSEL_SZ:1] BMULTSEL_REG = BMULTSEL;
reg [`DSP48E2__BREG_SZ-1:0] BREG_REG = BREG;
reg [`DSP48E2__B_INPUT_SZ:1] B_INPUT_REG = B_INPUT;
reg [`DSP48E2__CARRYINREG_SZ-1:0] CARRYINREG_REG = CARRYINREG;
reg [`DSP48E2__CARRYINSELREG_SZ-1:0] CARRYINSELREG_REG = CARRYINSELREG;
reg [`DSP48E2__CREG_SZ-1:0] CREG_REG = CREG;
reg [`DSP48E2__DREG_SZ-1:0] DREG_REG = DREG;
reg [`DSP48E2__INMODEREG_SZ-1:0] INMODEREG_REG = INMODEREG;
reg [`DSP48E2__IS_ALUMODE_INVERTED_SZ-1:0] IS_ALUMODE_INVERTED_REG = IS_ALUMODE_INVERTED;
reg IS_CARRYIN_INVERTED_REG = IS_CARRYIN_INVERTED;
reg IS_CLK_INVERTED_REG = IS_CLK_INVERTED;
reg [`DSP48E2__IS_INMODE_INVERTED_SZ-1:0] IS_INMODE_INVERTED_REG = IS_INMODE_INVERTED;
reg [`DSP48E2__IS_OPMODE_INVERTED_SZ-1:0] IS_OPMODE_INVERTED_REG = IS_OPMODE_INVERTED;
...
reg [`DSP48E2__MASK_SZ-1:0] MASK_REG = MASK;
reg [`DSP48E2__MREG_SZ-1:0] MREG_REG = MREG;
reg [`DSP48E2__OPMODEREG_SZ-1:0] OPMODEREG_REG = OPMODEREG;
reg [`DSP48E2__PATTERN_SZ-1:0] PATTERN_REG = PATTERN;
reg [`DSP48E2__PREADDINSEL_SZ:1] PREADDINSEL_REG = PREADDINSEL;
reg [`DSP48E2__PREG_SZ-1:0] PREG_REG = PREG;
reg [`DSP48E2__RND_SZ-1:0] RND_REG = RND;
reg [`DSP48E2__SEL_MASK_SZ:1] SEL_MASK_REG = SEL_MASK;
reg [`DSP48E2__SEL_PATTERN_SZ:1] SEL_PATTERN_REG = SEL_PATTERN;
reg [`DSP48E2__USE_MULT_SZ:1] USE_MULT_REG = USE_MULT;
reg [`DSP48E2__USE_PATTERN_DETECT_SZ:1] USE_PATTERN_DETECT_REG = USE_PATTERN_DETECT;
reg [`DSP48E2__USE_SIMD_SZ:1] USE_SIMD_REG = USE_SIMD;
reg [`DSP48E2__USE_WIDEXOR_SZ:1] USE_WIDEXOR_REG = USE_WIDEXOR;
reg [`DSP48E2__XORSIMD_SZ:1] XORSIMD_REG = XORSIMD;
