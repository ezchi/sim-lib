...
reg [`PLLE3_ADV__CLKFBOUT_MULT_SZ-1:0] CLKFBOUT_MULT_REG = CLKFBOUT_MULT;
...
reg [`PLLE3_ADV__CLKOUT0_DIVIDE_SZ-1:0] CLKOUT0_DIVIDE_REG = CLKOUT0_DIVIDE;
real CLKOUT0_DUTY_CYCLE_REG = CLKOUT0_DUTY_CYCLE;
real CLKOUT0_PHASE_REG = CLKOUT0_PHASE;
reg [`PLLE3_ADV__CLKOUT1_DIVIDE_SZ-1:0] CLKOUT1_DIVIDE_REG = CLKOUT1_DIVIDE;
real CLKOUT1_DUTY_CYCLE_REG = CLKOUT1_DUTY_CYCLE;
real CLKOUT1_PHASE_REG = CLKOUT1_PHASE;
reg [`PLLE3_ADV__CLKOUTPHY_MODE_SZ:1] CLKOUTPHY_MODE_REG = CLKOUTPHY_MODE;
real CLKPFD_FREQ_MAX_REG = CLKPFD_FREQ_MAX;
real CLKPFD_FREQ_MIN_REG = CLKPFD_FREQ_MIN;
reg [`PLLE3_ADV__COMPENSATION_SZ:1] COMPENSATION_REG = COMPENSATION;
reg [`PLLE3_ADV__DIVCLK_DIVIDE_SZ-1:0] DIVCLK_DIVIDE_REG = DIVCLK_DIVIDE;
...
reg [`PLLE3_ADV__STARTUP_WAIT_SZ:1] STARTUP_WAIT_REG = STARTUP_WAIT;
