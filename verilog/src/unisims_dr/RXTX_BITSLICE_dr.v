...
reg [`RXTX_BITSLICE__ENABLE_PRE_EMPHASIS_SZ:1] ENABLE_PRE_EMPHASIS_REG = ENABLE_PRE_EMPHASIS;
reg [`RXTX_BITSLICE__FIFO_SYNC_MODE_SZ:1] FIFO_SYNC_MODE_REG = FIFO_SYNC_MODE;
reg INIT_REG = INIT;
...
reg [`RXTX_BITSLICE__LOOPBACK_SZ:1] LOOPBACK_REG = LOOPBACK;
reg [`RXTX_BITSLICE__NATIVE_ODELAY_BYPASS_SZ:1] NATIVE_ODELAY_BYPASS_REG = NATIVE_ODELAY_BYPASS;
reg [`RXTX_BITSLICE__RX_DATA_TYPE_SZ:1] RX_DATA_TYPE_REG = RX_DATA_TYPE;
reg [`RXTX_BITSLICE__RX_DATA_WIDTH_SZ-1:0] RX_DATA_WIDTH_REG = RX_DATA_WIDTH;
reg [`RXTX_BITSLICE__RX_DELAY_FORMAT_SZ:1] RX_DELAY_FORMAT_REG = RX_DELAY_FORMAT;
reg [`RXTX_BITSLICE__RX_DELAY_TYPE_SZ:1] RX_DELAY_TYPE_REG = RX_DELAY_TYPE;
reg [`RXTX_BITSLICE__RX_DELAY_VALUE_SZ-1:0] RX_DELAY_VALUE_REG = RX_DELAY_VALUE;
real RX_REFCLK_FREQUENCY_REG = RX_REFCLK_FREQUENCY;
reg [`RXTX_BITSLICE__RX_UPDATE_MODE_SZ:1] RX_UPDATE_MODE_REG = RX_UPDATE_MODE;
reg [`RXTX_BITSLICE__SIM_DEVICE_SZ:1] SIM_DEVICE_REG = SIM_DEVICE;
real SIM_VERSION_REG = SIM_VERSION;
reg [`RXTX_BITSLICE__TBYTE_CTL_SZ:1] TBYTE_CTL_REG = TBYTE_CTL;
reg [`RXTX_BITSLICE__TX_DATA_WIDTH_SZ-1:0] TX_DATA_WIDTH_REG = TX_DATA_WIDTH;
reg [`RXTX_BITSLICE__TX_DELAY_FORMAT_SZ:1] TX_DELAY_FORMAT_REG = TX_DELAY_FORMAT;
reg [`RXTX_BITSLICE__TX_DELAY_TYPE_SZ:1] TX_DELAY_TYPE_REG = TX_DELAY_TYPE;
reg [`RXTX_BITSLICE__TX_DELAY_VALUE_SZ-1:0] TX_DELAY_VALUE_REG = TX_DELAY_VALUE;
reg [`RXTX_BITSLICE__TX_OUTPUT_PHASE_90_SZ:1] TX_OUTPUT_PHASE_90_REG = TX_OUTPUT_PHASE_90;
real TX_REFCLK_FREQUENCY_REG = TX_REFCLK_FREQUENCY;
reg [`RXTX_BITSLICE__TX_UPDATE_MODE_SZ:1] TX_UPDATE_MODE_REG = TX_UPDATE_MODE;
...
initial begin
  ...
  ATTR[`RXTX_BITSLICE__SIM_DEVICE] = SIM_DEVICE;
...
always @(trig_attr) begin
  ...
  SIM_DEVICE_REG = ATTR[`RXTX_BITSLICE__SIM_DEVICE];
